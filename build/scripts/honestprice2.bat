...
@rem ##########################################################################
@rem
@rem  honestprice2 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and HONESTPRICE2_OPTS to pass JVM options to this script.
...
:fail
rem Set variable HONESTPRICE2_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%HONESTPRICE2_EXIT_CONSOLE%" exit 1
exit /b 1
